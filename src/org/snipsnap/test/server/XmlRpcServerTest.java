...
public class XmlRpcServerTest extends TestCase {
  ...
  private static final String ADMIN_PASS = "123TM456";
  private static String admin_url;

  private static WebServer xmlRpcServer;
  private AdminXmlRpcClient xmlRpcClient;

  public static Test suite() {
    TestSetup testSetup = new TestSetup(new TestSuite(XmlRpcServerTest.class)) {
  ...
  protected static void oneTimeSetup() throws Exception {
    ...
    serverPrefs.put(ServerConfiguration.ADMIN_USER, ADMIN_USER);
    serverPrefs.put(ServerConfiguration.ADMIN_PASS, ADMIN_PASS);
    serverPrefs.flush();

    admin_url = serverPrefs.get(ServerConfiguration.ADMIN_URL, null);
  ...
  protected void setUp() throws Exception {
    xmlRpcClient = new AdminXmlRpcClient(admin_url, ADMIN_USER, ADMIN_PASS);
  }
