 ...
 *
 * @author stephan
 * @version $Id: SnipLink.java 1832 2005-08-08 13:15:47Z leo $
 */
...
//  }
  ...
  public static String getImageRoot() {
    return getCanonicalUrl("theme/images");
  }

  public static String getSpaceRoot() {
    return getCanonicalUrl("space");
  }

  public static String getExecRoot() {
    return getCanonicalUrl("exec");
  }

  public static String getCommentsRoot() {
    return getCanonicalUrl("comments");
  }

  private static String getCanonicalUrl(String url) {
    URL baseUrl = (URL) Application.get().getObject(Application.URL);
    if (null != baseUrl) {
      return baseUrl.toExternalForm() + "/" + url;
    }
    return url;
  }
