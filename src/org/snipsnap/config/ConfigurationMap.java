 ...
 * @see Configuration
 * @version $Id: ConfigurationMap.java 1606 2004-05-17 10:56:18Z leo $
 */
public class ConfigurationMap {
  ...
  public void storeGlobals(OutputStream stream) throws IOException {
    ConfigurationMap.globals.store(stream, "SnipSnap Globals Configuration $Revision: 1606 $");
  }
  ...
  public void store(OutputStream stream) throws IOException {
    properties.store(stream, "SnipSnap Configuration $Revision: 1606 $");
  }
