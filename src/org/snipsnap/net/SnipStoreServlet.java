 ...
 * @version $Id: SnipStoreServlet.java 1801 2005-01-29 17:26:09Z leo $
 */
public class SnipStoreServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (session != null) {
      ...
      if (service.isAuthenticated(user) && (null == snip || Security.checkPermission(PermissionType.EDIT, user, snip))) {
